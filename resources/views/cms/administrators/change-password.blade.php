...
<div class="card card-default">
    <div class="card-footer card-profile-footer">
        <ul class="nav nav-border-top justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="{{ route('administrators.change-password', $model) }}">Change Password</a>
            </li>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('administrators.do-change-password', $model->id) }}">
            @csrf
